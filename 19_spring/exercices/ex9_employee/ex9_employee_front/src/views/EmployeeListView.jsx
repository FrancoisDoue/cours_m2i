            ...
            <div key={e.id} className='card p-4 m-1'>
                <div className='row'>
                    ...
                    <div className='col-3 d-flex justify-content-end'>
                        <a onClick={() => navigate(`/employees/${e.id}`)} 
                            className='btn btn-outline-primary my-auto mx-2'
                            >Détails</a>
                        <a onClick={() => dispatch(deleteEmployee(e.id))} 
                            className='btn btn-outline-danger my-auto mx-2'
                            >Plan social</a>
                    </div>
                </div>
            </div>
