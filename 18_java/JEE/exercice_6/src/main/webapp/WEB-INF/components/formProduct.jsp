...
<form method="post" action="${pageContext.request.contextPath}/products<%= isEdit ? "?id=" + currentProduct.getId() : "" %>"
      class="w-50 m-auto">
    ...
    <div class="py-4 border-top border-light">
        <button class="btn btn-light w-100" ><%= isEdit ? "Modifier" : "Ajouter" %></button>
    </div>
</form>
