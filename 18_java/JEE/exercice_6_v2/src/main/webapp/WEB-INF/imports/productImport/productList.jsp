<%@ page import="exercice_6.entity.Product" %>
<%@ page import="java.time.format.DateTimeFormatter" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<jsp:useBean id="products" scope="request" type="java.util.ArrayList<exercice_6.entity.Product>" />
...
<%--            <% } %>--%>
        ...
        <td><%= product.getBuyAt().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) %></td>
        <td>
