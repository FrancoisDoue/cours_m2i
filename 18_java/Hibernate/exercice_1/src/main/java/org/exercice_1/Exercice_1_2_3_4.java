...
//                productRepository.getByDateBetween(start, end).forEach(System.out::println);
//                break;
...
//        System.out.println("Nombre de lignes affectées par la suppression de 'marque3' : " + productRepository.deleteByBrand("marque3"));
//
//        HibernateUtil.close();
